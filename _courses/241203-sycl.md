...
Knowledge of C++ and associated build systems would be helpful for attendees as SYCL is built on C++17 and does utilise modern C++ features.Knowledge of C++ and associated build systems would be helpful for attendees as SYCL is built on C++17 and does utilise modern C++ features.
