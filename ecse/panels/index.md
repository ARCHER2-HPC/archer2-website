...
- *ARCHER2-eCSE01-28 PI: Dr Alistair Revell (University of Manchester) Multi-Resolution Coupling for Exascale Engineering* (12 months) [[UKCOMES](https://www.ucl.ac.uk/mesoscale-modelling-consortium/)]
...
- *ARCHER2-eCSE02-2 PI: Dr Nathan L Abraham (Centre for Atmospheric Science) Reducing UM-UKCA data output using flight-track simulation* (12 months) [[NCAS](https://www.ncas.ac.uk/en/)]
...
- *ARCHER2-eCSE02-11 PI: Dr Joseph Parker (United Kingdom Atomic Energy Authority) Optimizing BOUT++ MPI+OpenMP hybrid performance by refactoring compute kernels* (6 months) [[Plasma HEC Consortium](https://plasma-ccp-hec.uk/)]
...
- *ARCHER2-eCSE02-13 PI: Dr James Harle (National Oceanography Centre) Containerisation of NEMO Employing Singularity (CONES)* (4 months) [[NOC](https://www.noc.ac.uk/)]
