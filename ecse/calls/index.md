...
summary: Details of open or most recent calls
banner: web_banners_06.jpg
---

<img src="GPU-eCSE02-timeline.png" alt="GPU eCSE02 Timeline"
	title="GPU eCSE02 Timeline" width="925"/>
	
### The 2nd GPU eCSE call  

GPU eCSE support provides funding to the UKRI research community to develop software in a sustainable manner to run on GPU-based architectures. We invite proposals to develop software that facilitates research targeted at UKRI’s digital research infrastructure e.g. future Exascale supercomputing services, UK national AI services, national Tier-2 HPC services. The call was open to research across all of UKRI’s remit. 
