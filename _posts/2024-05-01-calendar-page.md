---
layout: post
title: ARCHER2 Calendar May 2024
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 23 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the May page of the ARCHER2 2024 printed calendar.  </i></p>
