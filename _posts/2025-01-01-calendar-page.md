---
layout: post
title: ARCHER2 Calendar January 2025
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 5 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the January page of the ARCHER2 2025 printed calendar.  </i></p>
