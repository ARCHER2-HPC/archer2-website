---
layout: post
title: ARCHER2 Calendar January 2023
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 20 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the January page of the ARCHER2 2023 printed calendar.  </i></p>
