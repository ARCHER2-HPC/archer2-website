---
layout: post
title: ARCHER2 Calendar February 2025
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 2 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the February page of the ARCHER2 2025 printed calendar.  </i></p>
