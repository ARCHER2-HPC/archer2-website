---
layout: post
title: ARCHER2 Calendar August 2026
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 07 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the August page of the ARCHER2 2026 printed calendar.  </i></p>
