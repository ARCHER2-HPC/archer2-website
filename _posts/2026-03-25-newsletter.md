...
- [ARCHER2 Outreach and Public Engagement]({{ page.url }}#archer2-outreach-and-public-engagement), free webinar, Wednesday 25th March 2026 15:00 - 16:00 
...
- [CASTEP 26.1.1 available on ARCHER2]({{ page.url }}#castep-2611-available-on-archer2)
...
[Full details and join link]( https://www.archer2.ac.uk/training/courses/260325-outreach-vt/ )
...
If you have any questions or run into any issues with using CASTEP on ARCHER2, please [get in touch with the ARCHER2 Service Desk:](mailto:support@archer2.ac.uk)
