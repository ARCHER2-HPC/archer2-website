---
layout: post
title: ARCHER2 Calendar March 2023
...
<section id="service">
  <div class="container">
    ...
    {% assign entry_imagecomp = year_imagecomp | where_exp: "imagecomp", "imagecomp.entry_no == 15 " %}
...
{{ imagecomp.description }}
	...
	<p><i>This image was published on the March page of the ARCHER2 2023 printed calendar.  </i></p>
